...
blp = Blueprint("Tag", "tags", __name__, description="Opearation on tags")
...
class Tag(MethodView):
    ...
    @blp.alt_response(400, description="Returned if the tag is assigned to one or more items. In this case, this tag is nnot deleted")
